...
/>
	...
	s("a;", { t("<Alert>"), i(1), t("</Alert>") }),
	s("ad;", { t("<AlertDescription>"), i(1), t("</AlertDescription>") }),
	s("at;", { t("<AlertTitle>"), i(1), t("</AlertTitle>") }),
	...
	s("cdi;", { t("<CommandInput>"), i(1), t("</CommandInput>") }),
	s("cdl;", { t("<CommandList>"), i(1), t("</CommandList>") }),
	s("cde;", { t("<CommandEmpty>"), i(1), t("</CommandEmpty>") }),
	s("cdg;", { t("<CommandGroup>"), i(1), t("</CommandGroup>") }),
	s("cdi;", { t("<CommandItem>"), i(1), t("</CommandItem>") }),
	s("cds;", { t("<CommandSeparator>"), i(1), t("</CommandSeparator>") }),
