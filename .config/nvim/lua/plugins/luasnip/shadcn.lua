...
/>
	...
	s("dmg;", { t("<DropdownMenuTrigger asChild>"), i(1), t("</DropdownMenuTrigger>") }),
	s("dms;", { t("<DropdownMenuSeparator />") }),
	s("dmc;", { t("<DropdownMenuContent>"), i(1), t("</DropdownMenuContent>") }),
	s("dml;", { t("<DropdownMenuLabel>"), i(1), t("</DropdownMenuLabel>") }),
	s("dmgr;", { t("<DropdownMenuGroup>"), i(1), t("</DropdownMenuGroup>") }),
	...
	s("if;", {
		t('import { Form, FormField, FormItem, FormLabel, FormControl, FormDescription } from "@/components/ui/form";'),
	}),
