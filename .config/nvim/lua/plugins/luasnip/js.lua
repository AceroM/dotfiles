...
return {
	...
	s("ia;", { t('import axios from "axios"') }),
	...
	s("h.", { t('<header className="'), i(1), t('">'), i(2), t("</header>") }),
	...
	s("ty ", { t("typeof ") }),
	s("int ", { t("interface ") }),
	s("iq;", { t("import query from './query'") }),
	s("ro;", { t("readOnly") }),
	s("ix;", { t("import { useContext, Provider } from './context'") }),
	s("iy;", { t("import { Data } from './types'") }),
	s("nl;", { t("import Link from 'next/link'") }),
	s("nr;", { t("import { useRouter } from 'next/navigation'") }),
	s("rr;", { t("import { NextRequest, NextResponse } from 'next/server'") }),
	s("nj(", { t("NextResponse.json("), i(1) }),
	s("an;", { t("async (request: NextRequest"), i(1), t(") => {"), t({ "", "}" }) }),
	s("at;", { t("import axios from 'axios'"), t({ "", "" }), t({ "import toast from 'react-hot-toast'" }) }),
	s("ur;", { t("const router = useRouter()") }),
	s("ag(", { t("axios.get("), i(1) }),
	s("ap(", { t("axios.post("), i(1) }),
	s("ac(", { t("axios.create("), i(1) }),
	s("ak(", { t("axios.patch("), i(1) }),
	s("al(", { t("axios.put("), i(1) }),
	s("am(", { t("axios.delete("), i(1) }),
	s("a(", { t("axios("), i(1) }),
	s("rd{", { t("render={({ field, fieldState }) => ("), t({ "", "  " }), i(1), t({ "", ")" }) }),
}
