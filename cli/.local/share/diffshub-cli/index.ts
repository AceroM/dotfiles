...
// generic — defaults point at my redacted-public bucket / cdn.redacted.ai domain.
const R2_BUCKET = process.env.DIFFSHUB_R2_BUCKET || "redacted-public";
const R2_PUBLIC_BASE = (process.env.DIFFSHUB_R2_PUBLIC_BASE || "https://cdn.redacted.ai").replace(
  /\/+$/,
  "",
);
